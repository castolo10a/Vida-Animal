...
export default function AboutUs(){
    return (
        ...
        <div className="flex flex-col justify-center items-center mx-auto px-6 pt-20 pb-20 md:px-4">
            <h2 className="animate-fade-right animate-duration-[5000ms] text-gray-500 font-bold text-2xl md:text-4xl text-center z-10">Vida Animal: <br /> Un Viaje de Compromiso y Cuidado</h2>
            <p className="animate-fade-left animate-duration-[5000ms] mt-8 text-gray-700 py-4 text-base md:text-xl px-8">
        ...
        <div className="bg-wallpaper flex flex-col justify-center items-center mx-auto px-6 md:px-4 py-4 md:py-8">
            <h2 className="animate-fade-right animate-duration-[5000ms] text-gray-500 font-bold text-2xl md:text-4xl text-center z-10 pt-4">Misión</h2>
        ...
        <div className="flex flex-col justify-center items-center mx-auto px-6 md:px-4 py-4 md:py-8">
            <h2 className="animate-fade-right animate-duration-[5000ms] text-gray-500 font-bold text-2xl md:text-4xl text-center z-10 pt-4">Visión</h2>
            <p className="animate-fade-left animate-duration-[5000ms] mt-8 text-gray-700 text-base md:text-xl px-8">
